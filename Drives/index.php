					...
					<div class="top-nav">
						...
						<ul class="nav1">
							<li class="hvr-sweep-to-bottom">
								<a href="../Homepage/index.php">XIE Placements<i>Goto Placement Homepage</i></a>
							</li>
					...
					<ul class="rslides" id="slider3">
						<li>
							<div class="banner-info">
								<h2 style="color:blue";>Do What you Love with
									<span>Passion</span>
								</h2>
								<div class="line"></div>
								<p style="color:black";>Hold back, Our Training and Activities will get Your Script away from Your Laziness. We Dream with You to take You into the
									Reality of it. Just be Interactive and Initiate yourself to the Next Level of Placement Training</p>
							</div>
						</li>
						<li>
							<div class="banner-info">
								<h2 style="color:red";>Enrich your Brain with Sleek efforts like a
									<span>Paradise</span>
								</h2>
								<div class="line"></div>
								<p></p>
						...
						<li>
							<div class="banner-info">
								<h2 style="color:green";>We have got all the things you need to be a
		...
		<div class="footer">
			...
			<div class="container">
				...
				<div class="col-md-3 footer-right  wow fadeInRight animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<h6 style="color: white">Xavier Institute of Engineering</h6>
					<h4>
						<a href="../Homepage/index.php" style="color: white">XIE Campus Online Automation</a>
					</h4>
					<p></p>
				</div>
				<div class="clearfix"></div>
