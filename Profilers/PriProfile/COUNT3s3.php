...
{ 
$Csem = $_POST['csem'];
$RESULT = mysqli_query($mysqli,"SELECT count(*) FROM basicdetails WHERE `Approve`='1' AND Sem='$Csem'");
$data = mysqli_fetch_assoc($RESULT);
echo "<br><h3>Students in Semister '$Csem'&nbsp:&nbsp";
echo $data['count(*)'];
echo "</h3>";
$sql = mysqli_query($mysqli,"SELECT * FROM basicdetails WHERE `Approve`='1' AND Sem='$Csem' ORDER BY Branch");
