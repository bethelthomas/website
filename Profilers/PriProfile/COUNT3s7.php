...
{ 
$Cbe = $_POST['cbe'];
$RESULT = mysqli_query($mysqli,"SELECT count(*) FROM basicdetails WHERE `Approve`='1' AND BE>='$Cbe'");
$data = mysqli_fetch_assoc($RESULT);
echo "<br><h3>Students Scored Above '$Cbe' in BE Aggregate&nbsp:&nbsp";
echo $data['count(*)'];
echo "</h3>";
$sql = mysqli_query($mysqli,"SELECT * FROM basicdetails WHERE `Approve`='1' AND BE>='$Cbe'");
