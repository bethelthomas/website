...
<?php
        ...
        <div class="profile-photo-container">
          <img src="images/hod.jpg" alt="Profile Photo" class="img-responsive">
          ...
          <div class="templatemo-content-widget white-bg">
            ...
            <form action="cp.php" class="templatemo-login-form" method="POST" enctype="multipart/form-data">
              ...
              <div class="form-group text-right">
                <button type="submit" class="templatemo-blue-button" ><ahref="../../Profilers/HODProfile/login.php">Update<</a>/button>
